...
$config['db_name'] = 'marketplace_dev';
$config['db_user'] = 'root';
$config['db_password'] = 'astig.com.ph';
...
$config['http_host'] = 'dev.astig.com.ph';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'dev.astig.com.ph';
$config['https_path'] = '';
